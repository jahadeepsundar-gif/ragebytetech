      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal className="pb-10">
          <div className="inline-flex items-center gap-2 font-mono text-[11px] font-semibold text-accent uppercase tracking-widest">
            ...
            <span>STUDIO MANIFESTO &amp; PRINCIPLES</span>
          </div>
        ...
        <ScaleIn className="my-10 rounded-3xl border border-white/[0.08] bg-surface/80 p-6 sm:p-10 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
            {/* The Traditional Agency Model (Anti-Pattern) */}
            <div data-spotlight className="rounded-2xl border border-white/5 bg-black/40 p-6 sm:p-8 flex flex-col justify-between">
              <div>
            ...
            {/* The Kaatchi Productions Studio Model (Production Standard) */}
            <div className="rounded-2xl border border-accent/30 bg-surface/70 p-6 sm:p-8 shadow-[0_0_24px_rgba(17,17,17,0.036)] flex flex-col justify-between">
              <div>
                ...
                <h3 className="mt-5 font-display text-2xl sm:text-3xl font-extrabold uppercase tracking-tight text-white">
                  The Kaatchi Productions Paradigm
                </h3>
